...
validateCompoundStatementIndentation (Fundef a decos idnt ws1 name ws2 params ws3 t s) =
  (\decos' idnt' params' -> Fundef a decos' idnt' ws1 (coerce name) ws2 params' ws3 (coerce t)) <$>
